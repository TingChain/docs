...
This guide goes into detail on how to back up and restore a Ting Application Chain node instance. It covers the base folders and what they contain, as well as which files are critical for performing a successful backup and restore.

## Base folders <a href="#base-folders" id="base-folders"></a>

Ting Application Chain leverages LevelDB as its storage engine. When starting a Ting Application Chain node, the following sub-folders are created in the specified working directory:
...
It is critical for these folders to be preserved in order for the Ting Application Chain instance to run smoothly.
...
If any instance of the Ting Application Chain is running, it needs to be stopped in order for step 2 to be successful.

...
## Blockchain Interface <a href="#blockchain-interface" id="blockchain-interface"></a>

The Ting Application Chain uses the _**blockchain interface**_ to define all the methods that the JSON RPC module needs to use, in order to deliver its endpoints.
...
## ETH Endpoints <a href="#eth-endpoints" id="eth-endpoints"></a>
...
## Filter Manager <a href="#filter-manager" id="filter-manager"></a>
...
The Filter Manager relies heavily on Subscription Events, mentioned in the [Blockchain](https://github.com/ZChain-168168/zchain-docs/blob/main/docs/architecture/modules/blockchain/README.md#blockchain-subscriptions) section

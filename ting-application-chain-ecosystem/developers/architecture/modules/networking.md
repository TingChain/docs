...
A node has to communicate with other nodes on the network, in order to exchange useful information. To accomplish this task, the Ting Application Chain leverages the battle-tested **libp2p** framework.

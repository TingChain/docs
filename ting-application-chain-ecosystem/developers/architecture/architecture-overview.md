...
This is something that is present in almost all parts of the Ting Application Chain . Below, you will find a brief overview of the built architecture and its layering.

## Ting Application Chain Layering <a href="#zchains-layering" id="zchains-layering"></a>
...
The Blockchain layer is the central layer that coordinates everything in the Ting Application Chain system. It is covered in depth in the corresponding _Modules_ section.

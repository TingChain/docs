...
The below guide will instruct you on how to set up a Ting Application Chain network on your local machine for testing and development purposes.

The procedure differs greatly from the way you would want to set up Ting Application Chain network for a real use scenario on a cloud provider: [Cloud Setup](cloud-setup.md)

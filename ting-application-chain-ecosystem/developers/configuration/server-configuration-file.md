...
The configuration with default settings for the Ting Application Chain server can be exported into a config file in either `yaml` or `json` file format. This file can be used as a template for running the server using a configuration file.

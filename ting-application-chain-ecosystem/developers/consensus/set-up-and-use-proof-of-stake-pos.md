...
This guide goes into detail on how to set up a Proof of Stake network with the Ting Application Chain, how to stake funds for nodes to become validators and how to unstake funds.

It is **highly encouraged** to read and go through the Local Setup / Cloud Setup sections, before going along with this PoS guide. These sections outline the steps needed to start a Proof of Stake (PoS) cluster with the Ting Application Chain.

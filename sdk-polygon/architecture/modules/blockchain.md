...
One of the main modules of the TingChain are **Blockchain** and **State**.
...
**State** represents the _state transition_ object. It deals with how the state changes when a new block is included. Among other things, **State** handles:
...
**Blockchain** also has to deal with some parts relating to consensus (ex. _is this ethHash correct?_, _is this PoW correct?_). In one sentence, **it is the main core of logic through which all blocks are included**.

## WriteBlocks <a href="#writeblocks" id="writeblocks"></a>
...
The _WriteBlocks_ method is the entry point to write blocks into the blockchain. As a parameter, it takes in a range of blocks. Firstly, the blocks are validated. After that, they are written to the chain.
...
## Blockchain Subscriptions <a href="#blockchain-subscriptions" id="blockchain-subscriptions"></a>
...
:::tip Refresher Do you remember when we mentioned the _**monitor**_ command in the CLI Commands?

The Blockchain Events are the original events that happen in TingChain, and they're later mapped to a Protocol Buffers message format for easy transfer. :::

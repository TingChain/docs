...
_state/executor.go_ includes all the information needed for the TingChain to decide how a block changes the current state. The implementation of _ProcessBlock_ is located here.
